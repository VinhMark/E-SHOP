        ...
        <div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10'>
          <form className='space-y-6' onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1">
                <input type="text" name="fullName" id="fullName" autoComplete='fullName' required
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input type={visible ? 'text' : 'password'} name="password" id="password" autoComplete='current-password' required
                  className='appearance-none block w-full px-3 py-2 border
                   border-gray-300 rounded-md placeholder-gray-400
                    focus:outline-none focus:ring-blue-500 sm:text-sm'
                  value={user.password}
                ...
                {
                  !visible ? (
                    <AiOutlineEye size={25} className='absolute right-2 top-2 cursor-pointer'
                      onClick={() => setVisible(!visible)} />
                  ) : (
                    <AiOutlineEyeInvisible size={25} className='absolute right-2 top-2 cursor-pointer'
                      onClick={() => setVisible(!visible)} />
                  )
                }
            ...
            <div>
              ...
              <div className="mt-2 flex items-center">
                <span className="inline-block h-8 w-8 rounded-full overflow-hidden">
                  {user.avatar ? (
                    <img src={URL.createObjectURL(user.avatar)} alt="" className="w-full h-full object-cover object-center" />
                  ) : (
