...
const Footer = () => {
  return (
    <div className='bg-[#000] text-white'>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 sm:text-center">
        ...
        <ul className='px-5 text-center sm:text-start flex sm:block flex-col items-center'>
          ...
          <div className='flex items-center mt-[15px]'>
            ...
            <AiOutlineInstagram size={25} className='cursor-pointer ml-[15px]' />
            <AiOutlineYoutube size={25} className='cursor-pointer ml-[15px]' />
          </div>
        </ul>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 text-center pt-2 text-gray-400 text-sm pb-8'>
